...
public class AnalyzeView extends View {
    ...
    private void setup(AttributeSet attrs, Context context) {
        ...
        //axisBounds = new RectF(0.0f, 0.0f, 8000.0f, 60.0f);
    ...
    public enum GridScaleType {
        ...
        private GridScaleType(int value) {
            this.value = value;
        }
    ...
    public void setXShiftScale(float shift, float scale) {
        float limitXZoom;
        if (showMode == 0) {
        ...
        xZoom = clamp(scale, 1f, limitXZoom);
        xShift = clampXShift((shift / xZoom) / canvasWidth);
    }
...
//    t_old = t;
   ...
   */
    ...
    // maybe could save the whole view in main activity
